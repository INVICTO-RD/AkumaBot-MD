...
const dev = '👤 Antonio'; // Información del desarrollador
...
let handler = async (m, { conn, usedPrefix, text, args, command }) => {
  ...
  await sendContactArray(conn, m.chat, [
    [`${nomorown}`, `👑 Propietario`, `💨 ꧁༒Antonio༒꧂`, dev, 'arieldelarosas74@gmail.com', `RD 🇩🇴 `, `${global.yt}`, bio],
    [`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🐉`, `${packname}`, `📵 No Hacer Spam`, 'https://youtube.com/@kakarot-bot?si=dRYFi-dAw8H_mgGI', `Planeta Vegeta 🌍`, `https://github.com/INVICTO-RD/Kakarot-Bot-MD`, biobot]
  ], m);
};
