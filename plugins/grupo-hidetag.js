...
var handler = async (m, { conn, text, participants }) => {
    const icons = 'https://x.com/Nintenderos/status/1779092486356451519/photo/1'; // URL del ícono
    const redes = 'https://tudireccion.com'; // Reemplaza esto con tu URL deseada
    ...
    try { 
        ...
        let htextos = `${text ? text : "AKUMA-Bot-𝙈𝘿"}`;
