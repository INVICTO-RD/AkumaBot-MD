...
┃✿ _${usedPrefix}minarakumacoins | minarcoins_
...
┃✿ _${usedPrefix}darakumacoins *cantidad*_
...
┃✿ _${usedPrefix}delakumacoins *@tag*_
...
┃✿ _${usedPrefix}añadirakumacoins *@tag cantidad*_
`.trim()
await conn.sendFile(m.chat, gataVidMenu, 'gata.mp4', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' ৎ୭࠭͢𝔄𝔨𝔲𝔪𝔞-𝔅𝔬𝔱-𝔐𝔇𓆪͟͞   ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu }}})
