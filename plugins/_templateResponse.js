...
export async function all(m, chatUpdate) {
  ...
  // Siempre envía un texto string: primero el id si es comando, después el texto si existe, si no hay ninguno, manda string vacío
  const safeText = String(isIdMessage ? id : (text || id || ''));
