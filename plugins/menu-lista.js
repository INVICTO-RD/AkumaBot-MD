...
┃
┃✅ *_CUENTAS OFICIALES AKUMABOT_* ✅
┃➺ _${usedPrefix}cuentasakumabot | cuentasab_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' ৎ୭࠭͢𝔄𝔨𝔲𝔪𝔞-𝔅𝔬𝔱-𝔐𝔇𓆪͟͞   ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
